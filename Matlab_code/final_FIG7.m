...
%  Percentage of MUs served 3 GHz
opt_3g = [26 35 48 67 74 79];       % Xanh trơn
tla_3g = [15  28 40 62 69 73]; % Đỏ trơn

% Percentage of MUs served 2 GHz
opt_2g = [17 32 46 64 72 76];       % Xanh sọc
tla_2g = [12 26 38 61 66 70];      % Đỏ sọc
...
for i = 1:4
    ...
    text(x_vals + offset, y_vals + 0.5, labels, ...
